...
public class WithMockCustomUnAuthorizedUserSecurityContextFactory implements WithSecurityContextFactory<WithMockCustomUnAuthorizedUser> {
    @Override
    public SecurityContext createSecurityContext(WithMockCustomUnAuthorizedUser annotation) {
